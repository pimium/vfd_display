...
void TM1637_display_time(uint16_t time){
	uint8_t min = time / 60;
  uint8_t sec = time % 60;
  TM1637_display_digit(TM1637_SET_ADR_00H, min / 10);
  TM1637_display_digit(TM1637_SET_ADR_01H, min % 10);
  TM1637_display_digit(TM1637_SET_ADR_02H, sec / 10);
  TM1637_display_digit(TM1637_SET_ADR_03H, sec % 10);
}
void
