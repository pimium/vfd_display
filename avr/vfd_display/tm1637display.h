...
#define SEG_G   0b01000000
  ...
  //void setSegments(unsigned int segments[], unsigned int length = 4, unsigned int pos = 0);
  ...
  //void showNumberDec(int num, unsigned int leading_zero = false, unsigned int length = 4, unsigned int pos = 0);
